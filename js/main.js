var data = [
  ...
  for (let movies = 0; movies < data.length; movies++) {
    var card = document.createElement('div')
    card.innerHTML = `
    <div class="card mb-3">
        <div class="row">
            <div class="col-md-4">
                <img src="`+ data[movies]['Poster'] +` " class="card-img" alt="...">
            </div>
            <div class="col-md-8">
                <div class="card-body">
                    <h5 class="card-title">` + data[movies]['Title'] + `</h5>
                    <p class="card-text">` + data[movies]['Plot'] + `</p>
                    <div class="infos">
                        <p class="card-text"> `+ data[movies]['Year'] +` </p>
                        <p class="card-text"> `+ data[movies]['Director'] +` </p>
                        <p class="card-text"> `+ data[movies]['Runtime'] +` </p>
                        <p class="card-text"> Notation: ` + data[movies]['imdbRating'] + `</p>
                    </div>
                    <div class="movies_img col-md-6">
                        <img src="`+ data [movies]['Images'][0] +` " class="card-img" alt="...">
                        <img src="`+ data [movies]['Images'][1] +` " class="card-img" alt="...">
                        <img src="`+ data [movies]['Images'][2] +` " class="card-img" alt="...">
                    </div>
                </div>
            </div>
        </div>
